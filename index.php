...
if (isset($_GET['view'])){
    ...
    extract($_GET);
    if($view==1){
        require_once("auteur.html.php"); 
    }elseif ($view==2){
        require_once("exemplaire.html.php");
    }elseif ($view==3){
        require_once("adherent.html.php");
    }elseif ($view==4){
        require_once("ouvrage.html.php");
    }elseif ($view==5){
        require_once("pret.html.php");
    }elseif ($view==6){
        require_once("demande.html.php");
    }
}else{
    require_once("bib.html.php");
}
